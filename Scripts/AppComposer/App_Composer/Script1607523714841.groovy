...
try {
	...
	switch (userChoice) {
		...
		case'PublishAll':
			...
			WebUI.setText(findTestObject('LoginPage/username_txtbx'),'david')
			extentTest.log(Status.PASS, 'Enter username david ')
			WebUI.setText(findTestObject('LoginPage/password_txtbx'), 'david')
			extentTest.log(Status.PASS, 'Enter  password  david')
